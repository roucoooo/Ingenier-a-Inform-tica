        ...
        private void drawGrid(Graphics2D g) {
            ...
            for (int x = 0; x < gridWidth; x++) {
                for (int y = 0; y < gridHeight; y++) {
                  ...
                  switch (grid[x][y]) {
                        case EMPTY: g.setColor(new Color(250, 250, 250)); break;
                        case ENTRANCE: g.setColor(new Color(200, 255, 200)); break;
                        case CLASSIFICATION: g.setColor(new Color(255, 255, 200)); break;
                        case EXIT: g.setColor(new Color(255, 150, 0)); break;
                        case STORAGE: g.setColor(new Color(220, 220, 255)); break;
                        case SHELF: g.setColor(new Color(180, 180, 200)); break;
                        case BLOCKED: g.setColor(new Color(255, 100, 100)); break;
